...
function StartGame(){
    ...
    var y=0;
        for(var x=1; x<=4; x++,y++){
        var test = document.getElementById("ga4r1"+x);
    ...
    for(var x=1; x<=4; x++,y++){
        var test = document.getElementById("ga4r2"+x);
            if($(test).hasClass("hide")){     
            }
            else{
         test.innerHTML=(numbersArray[y]);
    ...
    for(var x=1; x<=4; x++, y++){
        var test = document.getElementById("ga4r3"+x);
        if($(test).hasClass("hide")){  
    ...
    for(var x=1; x<=4; x++, y++){
        var test = document.getElementById("ga4r4"+x);
        if($(test).hasClass("hide")){     
            }
            else{
        test.innerHTML = (numbersArray[y]);
...
function resetScore(){
    ...
    for(var x=1; x<=4; x++){
        var vis = document.getElementById("ga4r1"+x);
    ...
    for(var x=1; x<=4; x++){
        var vis = document.getElementById("ga4r2"+x);
            if($(vis).hasClass("hide")){
                $(vis).toggleClass("hide");     
            } 
            }
    for(var x=1; x<=4; x++){
        var vis = document.getElementById("ga4r3"+x);
            if($(vis).hasClass("hide")){
                $(vis).toggleClass("hide");     
            } 
            }
    for(var x=1; x<=4; x++){
        var vis = document.getElementById("ga4r4"+x);
            if($(vis).hasClass("hide")){
                $(vis).toggleClass("hide");     
            } 
            }
