...
function StartGame(){
    ...
    var y=0;
        for(var x=1; x<=5; x++,y++){
        var test = document.getElementById("ga5r1"+x);
    ...
    for(var x=1; x<=5; x++,y++){
        var test = document.getElementById("ga5r2"+x);
        if($(test).hasClass("hide")){
    ...
    for(var x=1; x<=5; x++, y++){
        var test = document.getElementById("ga5r3"+x);
        if($(test).hasClass("hide")){
    ...
    for(var x=1; x<=5; x++, y++){
        var test = document.getElementById("ga5r4"+x);
        if($(test).hasClass("hide")){
    ...
    for(var x=1; x<=5; x++, y++){
        var test = document.getElementById("ga5r5"+x);
        if($(test).hasClass("hide")){
...
function resetScore(){
    ...
    for(var x=1; x<=5; x++){
        var vis = document.getElementById("ga5r1"+x);
    ...
    for(var x=1; x<=5; x++){
        var vis = document.getElementById("ga5r2"+x);
            if($(vis).hasClass("hide")){
                $(vis).toggleClass("hide");     
            } 
            }
    for(var x=1; x<=5; x++){
        var vis = document.getElementById("ga5r3"+x);
            if($(vis).hasClass("hide")){
                $(vis).toggleClass("hide");     
            } 
            }
    for(var x=1; x<=5; x++){
        var vis = document.getElementById("ga5r4"+x);
            if($(vis).hasClass("hide")){
                $(vis).toggleClass("hide");     
            } 
            }
    for(var x=1; x<=5;x++){
        var vis = document.getElementById("ga5r5"+x);
            if($(vis).hasClass("hide")){
                $(vis).toggleClass("hide");
            }
    }
